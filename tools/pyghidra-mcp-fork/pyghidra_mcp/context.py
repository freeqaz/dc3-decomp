...
class PyGhidraContext:
    ...
    def import_binary(self, binary_path: str | Path, language: str | None = None,
                      compiler: str | None = None) -> "ghidra.program.model.listing.Program":
        """
    ...
    def import_binaries(self, binary_paths: list[str | Path], language: str | None = None,
        ...
        Args:
            ...
            language: Optional Ghidra language ID for all imported binaries.
            compiler: Optional compiler spec ID for all imported binaries.
        """
        for bin_path in binary_paths:
            self.import_binary(bin_path, language=language, compiler=compiler)
