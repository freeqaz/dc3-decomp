...
A Ghidra extension for loading and analyzing Xbox 360 XEX executables. Essential for reverse engineering the original DC3 binary.
...
The original DC3 executable is at `orig/373307D9/default.xex`.
