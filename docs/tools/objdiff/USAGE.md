...
```bash
objdiff-cli report summary build/373307D9/report.json
objdiff-cli report summary build/373307D9/report.json -f text        # Human-readable
objdiff-cli report summary build/373307D9/report.json --category game # Filter by category
```
...
objdiff-cli report query build/373307D9/report.json --units \
...
objdiff-cli report function build/373307D9/report.json "Shuttle::Set.*"  # Regex (matches SetActive, etc.)
objdiff-cli report function build/373307D9/report.json "Game::Poll" --exact  # Escapes regex chars
```
...
objdiff-cli report function build/373307D9/report.json "MyFunc" \
