...
The map file (`orig/373307D9/ham_xbox_r.map`) gives symbol → VA mapping.
The symbols file (`config/373307D9/symbols.txt`) gives function sizes.
...
function:
  ...
  decomp_obj: "build/373307D9/src/system/hamobj/RhythmBattle.obj"
...
python3 tools/unicorn_runner.py \
    --symbol "?OnBeat@RhythmBattle@@AAAXXZ" \
    --obj build/373307D9/src/system/hamobj/RhythmBattle.obj \
    --binary orig/373307D9/ham_xbox_r.exe \
...
python3 tools/unicorn_runner.py \
    ...
    --obj build/373307D9/src/system/meta/Game.obj \
    --auto-fixture
...
python3 tools/unicorn_runner.py \
    ...
    --reference-obj build/373307D9/src/system/meta/Game.obj \
    --auto-fixture \
    --score
```
...
Phase 1 uses the original .obj files (from `build/373307D9/src/`) instead of extracting from the linked binary. This is simpler and provides relocations for patching. Direct binary extraction is only needed if .obj files are unavailable.
