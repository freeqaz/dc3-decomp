...
| `RndText::FitTextScroll()` | `?FitTextScroll@RndText@@IAAXXZ` | 98.2% | Near-match (re-measured 2026-08-04; the old 96.7% was the intermediate after Lever 2 only) |
...
| `RndText::SizeCheck()` | `?SizeCheck@RndText@@IAAXXZ` | 98.6% | Near-match (re-measured 2026-08-04; residual is one `mr r4, r27` moved two slots) |
