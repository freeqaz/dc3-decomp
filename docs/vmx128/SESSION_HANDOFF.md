...
| VMX128 intrinsics | `~/code/milohax/dc3-decomp/src/xdk/LIBCMT/vectorintrinsics.h` |
| Gesture targets doc | `~/code/milohax/dc3-decomp/docs/vmx128/GESTURE_TARGETS.md` |
...
ninja build/373307D9/src/system/gesture/File.obj
