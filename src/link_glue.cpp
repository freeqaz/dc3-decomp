...
// ??__E dynamic initializers — satisfy auto_08 __xc table references
// Real initialization happens via decomp .CRT$XCU entries in _cinit
...
// ??__E dynamic initializers — redirected to noop (real init via decomp .CRT$XCU entries)
