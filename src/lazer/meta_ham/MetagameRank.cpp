...
void MetagameRank::UpdateScore(
    ...
    if (!TheHamProvider->Property("is_in_party_mode")->Int()
        ...
        if (xp_force_award_small.Int() || xp_force_award_medium.Int()
            ...
            switch (TheGameData->Player(playerData->PlayerIndex())->GetDifficulty()) {
                ...
                if (TheHamProvider->Property(is_in_campaign_mode)->Int()) {
                    ...
                    if (performer) {
                        ...
                        if (shortname == craze) {
                            ...
                            switch (
                                TheGameData->Player(playerData->PlayerIndex())->GetDifficulty()
                            ) {
                            case kDifficultyEasy:
            ...
            Difficulty d1 = TheGameData->Player(playerData->PlayerIndex())->GetDifficulty();
