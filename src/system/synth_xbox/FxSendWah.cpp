...
// Marshals the FxSendWah base members into the XAPO WahEffect::Params (size 0x28). Our
// Params keeps its native-facing field names; the comments give the target semantic at
// each offset. Field-0 (bypass) is reassigned late, matching the target store order.
