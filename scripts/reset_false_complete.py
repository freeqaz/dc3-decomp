...
748 functions were falsely marked COMPLETE during initial DB population (Jan 2026)
when objdiff reported 100% match for functions where the original binary's section
had 0 bytes. This script resets them to workable state.
"""
import sqlite3
import sys
